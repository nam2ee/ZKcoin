...
const functions = {
    ...
    loadContract: async (args)=>{
        const { game } = await __webpack_require__.e(/* import() */ 475).then(__webpack_require__.bind(__webpack_require__, 9475));
        state.game = game;
    },
    ...
    createSetAnswerTransaction: async (args)=>{
        const transaction = await o1js__WEBPACK_IMPORTED_MODULE_0__/* .Mina */ .No.transaction(async ()=>{
            await state.zkapp.setAnswer((0,o1js__WEBPACK_IMPORTED_MODULE_0__/* .Field */ .gN)(args.answer));
        });
        state.transaction = transaction;
    },
    createGuessTransaction: async (args)=>{
        const transaction = await o1js__WEBPACK_IMPORTED_MODULE_0__/* .Mina */ .No.transaction(async ()=>{
            await state.zkapp.guess((0,o1js__WEBPACK_IMPORTED_MODULE_0__/* .Field */ .gN)(args.guess));
        });
        state.transaction = transaction;
    },
...
/******/ 			if (chunkId === 674) return "static/chunks/982f5ae2-e3a9e678f4bc5b87.js";
/******/ 			// return url for filenames based on template
/******/ 			return "static/chunks/" + chunkId + "." + "a604585527d3de50" + ".js";
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ 	!function() {
/******/ 		__webpack_require__.p = "/zkcoin/_next/";
/******/ 	}();
/******/ 	
